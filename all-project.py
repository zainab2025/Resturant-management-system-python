...
def addDiscount():
    with open ('DsicountsPy.txt','a') as file:
        ...
        while c=='y':
            ...
            original_price=input('Entre the original price: ')
            final_price=int(original_price)-((int(discount_amount)/100)*int(original_price))
            file.write(discount_id+'\t\t'+product_name+'\t\t'+start_date+'\t\t'+end_date+'\t\t'+discount_amount+'\t'+final_price+'\n')
...
def displayDiscounts():
    with open ('DsicountsPy.txt','r') as file:
        print ('discount_id\tproduct_name\tstart_date\tend_date\tdiscount_amount\tprice_after_discount')
        print ("------------------------------------------------------------------------------------------")
...
def home2():
  ...
  while c == "y":
    ...
    print("\t\t\t\t****Welcome to us. Our service is to deliver food to homes***")
    print("\t\t\t\t\t\t***We wish you a good service***")
    print("1.Signup \t2.SignIn \t3.Logout \t4.Update_Password \t5.DisplayAllRecord \nEnter your choice : ")
    c = input("your choice: ")
